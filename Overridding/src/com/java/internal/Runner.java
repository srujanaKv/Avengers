...
public class Runner {
    public static void main(String[] args) {
        System.out.println("worm is created");
        Worm worm = new Worm();
        worm.Shape();
        Worm w = new Color();
        w.Shape();
        ...
        System.out.println("metro is created");
        ...
        System.out.println("brinjal is created");

        Brinjal brinjal = new Brinjal();
        brinjal.Cook();

        Brinjal b = new PurpleBrinjal();
        b.Cook();

        PurpleBrinjal purple = new PurpleBrinjal();
        purple.Cook();
        purple.Taste();
        ...
        System.out.println("river is created");
        ...
        System.out.println("cloud is created");

        Cloud cloud = new Cloud();
        cloud.Rain();

        Cloud cloud1 = new StormCloud();
        cloud1.Rain();
        ...
        System.out.println("stone is created");

        Stone stone = new Stone();
        stone.Weight();

        Stone stone1 = new Granite();
        stone1.Weight();
        ...
        System.out.println("ocean is created");
        ...
        System.out.println("music is created");

        Music music = new Music();
        music.Play();

        Music music1 = new Melody();
        music1.Play();
        ...
        Machine machine1 = new RobotMachine();
        machine1.Operate();

        RobotMachine robotMachine = new RobotMachine();
        robotMachine.Operate();
        robotMachine.Task();
        ...
        System.out.println("egg is created");

        Egg egg = new Egg();
        egg.Hatch();

        Egg egg1 = new ChickenEgg();
        egg1.Hatch();
        ...
        Telescope telescope1 = new SpaceScope();
        telescope1.Zoom();
        ...
        System.out.println("stove is created");

        Stove stove = new Stove();
        stove.Burn();

        Stove stove1 = new GasStove();
        stove1.Burn();

        GasStove gas = new GasStove();
        gas.Burn();
        gas.Ignite();
        ...
        Mushroom mushroom1 = new ButtonMushroom();
        mushroom1.Grow();

        ButtonMushroom btn = new ButtonMushroom();
        btn.Grow();
        btn.Cook();


        System.out.println("slipper is created");

        Slipper slipper = new Slipper();
        slipper.Wear();

        Slipper slipper1 = new RubberSlipper();
        slipper1.Wear();

        RubberSlipper rs = new RubberSlipper();
        rs.Wear();
        rs.Grip();
        ...
        Rubberband rubberband1 = new ColorBand();
        rubberband1.Stretch();
        ...
        Sweetcorn sweetcorn1 = new MasalaCorn();
        sweetcorn1.Roast();

        MasalaCorn corn = new MasalaCorn();
        corn.Roast();
        corn.Spice();
        ...
        Panipuri panipuri1 = new SpicyPuri();
        panipuri1.Serve();

        SpicyPuri puri = new SpicyPuri();
        puri.Serve();
        puri.Taste();
        ...
        System.out.println("skin is created");

        Skin skin = new Skin();
        skin.Glow();

        Skin skin1 = new MoistSkin();
        skin1.Glow();

        MoistSkin ms = new MoistSkin();
        ms.Glow();
        ms.Hydrate();
        ...
        System.out.println("seriel is created");

        Seriel seriel = new Seriel();
        seriel.Stream();

        Seriel seriel1 = new DramaSeriel();
        seriel1.Stream();

        DramaSeriel ds = new DramaSeriel();
        ds.Stream();
        ds.Episode();
        ...
        Nailpolish n = new GlitterPolish();
        n.Coat();
        ...
        Earring earring1 = new StudEarring();
        earring1.Wear();

        StudEarring stud = new StudEarring();
        stud.Wear();
        stud.Sparkle();


        System.out.println("paint is created");
        ...
        Earphone e = new BluetoothEarphone();
        e.Connect();

        BluetoothEarphone be = new BluetoothEarphone();
        be.Connect();
        be.Charge();


        System.out.println("boost is created");

        Boost boost = new Boost();
        boost.Drink();

        Boost boost1 = new EnergyBoost();
        boost1.Drink();

        EnergyBoost eb = new EnergyBoost();
        eb.Drink();
        eb.Energize();
        ...
        Bournvita bournvita1 = new ChocoBournvita();
        bournvita1.Mix();
        ...
        FrenchFry fry = new FrenchFry();
        fry.Fry();

        FrenchFry frenchFry = new CrispyFry();
        frenchFry.Fry();

        CrispyFry cf = new CrispyFry();
        cf.Fry();
        cf.Serve();
        ...
        Spiderman spiderman = new MilesMorales();
        spiderman.Swing();
